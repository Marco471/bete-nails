  ...
  return (
    <main className="min-h-screen bg-[#f8f1f3] text-[#3d3035]">
      ...
      <section className="relative overflow-hidden bg-[#3d3035] px-6 py-28 text-center text-white">
        <div className="absolute -left-32 -top-32 h-80 w-80 rounded-full bg-[#c99eaa]/20 blur-3xl" />

        <div className="absolute -bottom-32 -right-32 h-80 w-80 rounded-full bg-[#c99eaa]/20 blur-3xl" />
